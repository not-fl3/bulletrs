...
fn main() {
    ...
    cc::Build::new()
        ...
        .define("BT_USE_DOUBLE_PRECISION", None)
        .define("Bullet3Common_EXPORTS", None)
        .define("B3_USE_STANDALONE_EXAMPLE", None)
        .define("DYNAMIC_LOAD_X11_FUNCTIONS", Some("1"))
        .define("GLEW_DYNAMIC_LOAD_ALL_GLX_FUNCTIONS", Some("1"))
        .define("GLEW_INIT_OPENGL11_FUNCTIONS", Some("1"))
        .define("GLEW_STATIC", None)
        ...
        .file("bullet3/examples/SharedMemory/PhysicsClientExample.cpp")
        ...
        .file("bullet3/examples/SharedMemory/PhysicsLoopBack.cpp")
        .file("bullet3/examples/SharedMemory/PhysicsLoopBackC_API.cpp")
        .file("bullet3/examples/SharedMemory/PhysicsClientSharedMemory_C_API.cpp")
        .file("bullet3/examples/SharedMemory/PhysicsClientSharedMemory2_C_API.cpp")
        .file("bullet3/examples/SharedMemory/PhysicsClientSharedMemory2.cpp")
        .file("bullet3/examples/SharedMemory/SharedMemoryCommandProcessor.cpp")
